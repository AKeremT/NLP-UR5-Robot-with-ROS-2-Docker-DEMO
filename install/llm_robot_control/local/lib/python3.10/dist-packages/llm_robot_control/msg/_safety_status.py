...
class Metaclass_SafetyStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('llm_robot_control')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'llm_robot_control.msg.SafetyStatus')
            logger.debug(
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'violations' field must be a set or sequence and each value of type 'str'"
