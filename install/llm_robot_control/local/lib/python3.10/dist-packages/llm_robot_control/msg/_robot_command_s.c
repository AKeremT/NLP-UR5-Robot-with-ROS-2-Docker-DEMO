...
bool llm_robot_control__msg__robot_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("llm_robot_control.msg._robot_command.RobotCommand", full_classname_dest, 49) == 0);
  }
  llm_robot_control__msg__RobotCommand * ros_message = _ros_message;
  {  // command_type
...
PyObject * llm_robot_control__msg__robot_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("llm_robot_control.msg._robot_command");
