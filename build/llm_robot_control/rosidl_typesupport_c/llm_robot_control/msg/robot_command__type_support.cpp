...
static const _RobotCommand_type_support_symbol_names_t _RobotCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_robot_control, msg, RobotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_robot_control, msg, RobotCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_robot_control, msg, RobotCommand)() {
  return &::llm_robot_control::msg::rosidl_typesupport_c::RobotCommand_message_type_support_handle;
}
